(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.TraeBadge = {}));
...
`;
  ...
  exports.BADGE_CSS = BADGE_CSS;
  exports.DEFAULT_OPTIONS = DEFAULT_OPTIONS;
  exports.TRAE_LOGOS = TRAE_LOGOS;
  exports.TraeBadge = TraeBadge;
  exports.autoInit = autoInit;
  exports.autoSelectTheme = autoSelectTheme;
  exports.createBadge = createBadge;
  exports.default = TraeBadge;
  exports.destroyAllBadges = destroyAllBadges;
  exports.detectBackgroundColor = detectBackgroundColor;
  exports.getGlobalInstance = getGlobalInstance;
  exports.getLuminance = getLuminance;
  exports.isDarkBackground = isDarkBackground;
  exports.isSupported = isSupported;
  exports.parseColor = parseColor;
  exports.traeBadgePlugin = traeBadgePlugin;
